...
public class CardPublicKeyCertificate {
    ...
    public CardPublicKeyCertificate(EmvPublicKey publicKey,
                                    byte certFormat,
    ...
    public static CardPublicKeyCertificate fromBytes(byte[] publicKeyCertificateData,
        ...
        int cardPublicKeyModLengthTotal = bis.read() & 0xFF;

        int cardPublicKeyExpLengthTotal = bis.read() & 0xFF;

        int modBytesLength = parentKey.getKey().length - 42;
        ...
        return new CardPublicKeyCertificate(cardPublicKey,
                certFormat,
                certExpirationDate,
                certSerialNumber,
